...
export function DocumentDetailPage() {
    ...
    if (isLoading)
        return <main className="article-page"><p>Загружаем документ…</p></main>;
    if (isError || !item)
        return <main className="article-page"><Link to="/dokumenty">← Все документы</Link><h1>Документ не найден</h1></main>;
